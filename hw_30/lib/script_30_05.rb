# ========================================================================
# Script             =   script_30_05.rb
# ========================================================================
# Description     =   "Using optionParser & input from  DB using csv-file get "Average score of (35, 45, 61, 59 and 73) is 54.6"
# Name            =    "Your Name"
...
begin
    ...
    puts "Average score of (35, 45, 61, 59 and 73) is #{(items[0].to_f+items[1].to_f+items[2].to_f+items[3].to_f+items[4].to_f)/5}"
