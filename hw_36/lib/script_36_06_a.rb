...
# Script             =   36_06a.rb
# ========================================================================
# Description     =   "Using optionParser & input/output from/to DB usig csv-file get: 'Average score of (35, 45, 61, 59 and 73) is 7'"
...
#Getting output into database
    ...
    output = "Average score of (35, 45, 61, 59 and 73) is #{(items[0].to_i+items[1].to_i+items[2].to_i+items[3].to_i+items[4].to_i+items[5].to_i)/items.size}"
