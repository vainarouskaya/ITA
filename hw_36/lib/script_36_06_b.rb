...
# Script             =   36_06b.rb
# ========================================================================
# Description     =   "Using optionParser & input/output from/to  DB using csv-file get: 'Average score of (35, 45, 61, 59 and 73) is 55060.5"
...
#Getting output into database
    ...
    output = "Average score of (23, 15, 97, 45 365, 1234, 523665, 45, 2971 and 22145) is #{(items[0].to_f+items[1].to_f+items[2].to_f+items[3].to_f+items[4].to_f+items[5].to_f+items[6].to_f+items[7].to_f+items[8].to_f+items[9].to_f)/items.size}"
