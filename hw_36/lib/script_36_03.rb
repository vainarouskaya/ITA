# ========================================================================
# Script             =   script_36_03.rb
# ========================================================================
# Description     =   "Using optionParser & input/output from/to  DB using csv file get "When I am dividing 100 by 10 I am always have 10!"
# Name            =    "Your Name"
...
#Getting output into database
    ...
    output = "When I am dividing #{items[0]} by #{items[1]} I am always have #{items[0].to_i/items[1].to_i}!"
