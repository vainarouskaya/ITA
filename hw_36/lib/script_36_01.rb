# ========================================================================
# Script             =   script_36_01.rb
# ========================================================================
# Description     =   "Using optionParser and input/output form/to  DB using csv-file get "My favorite fruits are: apples and bananas"
# Name            =    "Your Name"
...
#Getting output into database
    ...
    output = "My favorite fruits are #{items[0]}s and #{items[1]}s"
