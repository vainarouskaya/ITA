# ========================================================================
# Script             =   script_36_04.rb
# ========================================================================
# Description     =   "Using optionParser & input/output from/to  DB using csv-file get: "My IP Address is: 20.55.444.112"
# Name            =    "Your Name"
...
#Getting output into database
    ...
    output = "My IP Address is: #{items[0]}.#{items[1]}.#{items[2]}.#{items[3]}"
