...
# Script             =   36_08.rb
# ========================================================================
# Description     =   "Using optionParser & input/output from/to DB using csv-file get : Here are sorted (alphabetically) words: Fall Spring Summer Winter"
...
#Getting output into database
    ...
    output = "Here are sorted (alphabetically) words: #{items.sort.join(" ")}"
